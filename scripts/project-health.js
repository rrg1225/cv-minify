...
const problems = [];
for (const file of ["README.md", "package.json", "src/lib/documentQuality.js", ".github/workflows/ci.yml"]) {
...
for (const section of ["Features", "Scripts", "Quality Gates", "Roadmap"]) {
